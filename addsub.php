...
if (!(isset($_SESSION['loggedin'])) || $_SESSION['loggedin'] !== true) {
	...
	if (isset($_POST["newsub"])) {
		...
		$q1 = "SELECT * FROM `subject` WHERE sub_name = '$subname' ";
	...
	<div class="login-form">
		<form method="post" action="addsub.php">
			<div class="form-group row">
				...
				<div class="col-8">
					<input type="text" class="form-control" name="subname" required="required">
				</div>
			</div> 
			<div class="form-group row">
				<div class="col-8 offset-4">
					<input type="submit" name="newsub" value="Add Subject"> <br><br>
